...
<%
	//接收NewsView.java后端servlet中传过来的新闻信息，只有一篇新闻，不是列表
  	Map<String, Object> newbyid = (Map<String, Object>)request.getAttribute("newbyid");
%>
...
<body>
	...
	<div class="header">
		...
		<div class="ppt">
				<!--需求：在class为ppt的盒子里面做一个包含类三张图片的轮播效果-->
	...
	<!--主体开始-->
		<div class="main">
			...
			<div class="rightlist">
				<h3><%=newbyid.get("tbtitle")%></h3>
				<p class="info">作者：<%=newbyid.get("tbauthor")%>  来源：<%=newbyid.get("tbsource")%> 发布时间：<%=newbyid.get("tbcreatetime")%></p>
				<div class="contents">
					<%=newbyid.get("tbdetails")%>
				</div>
			</div>
